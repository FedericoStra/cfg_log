...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/FedericoStra/cfg_log/rust.yml?logo=githubactions&logoColor=white)](https://github.com/FedericoStra/cfg_log/actions/workflows/rust.yml)
